...
public class KademliaValueLookUp implements Runnable
{
    ...
    int a ;
    Node n;
    KademliaValueLookUp(KademliaProtocol protocol, KademliaRoutingTable rt, ArrayList<Node> nodes,byte[] nodeId, int a, Node n)
    {
        this.rt = rt;
    ...
    public void run()
    {
        ...
        FindValueResponse response = protocol.findValueOp(nodeId,nodeId, n.getIp(),n.getPort()).getNodesList();
